...
class Speed(object):
	...
	def __init__(self, pPinA, pPinB):
		...
		self._rotaryEncoder = emaginariumlib.RotaryEncoder(pPinA,pPinB)
...
if __name__ == "__main__":
	...
	sRosPublisher = rospy.Publisher('emaginarium/Speed', emaginarium.msg.Speed, queue_size=5)
	...
	while not rospy.core.is_shutdown():
		...
		time.sleep(0.05)
		# Message publication
		sRosPublisher.publish(emaginarium.msg.Speed(lSpeed))
