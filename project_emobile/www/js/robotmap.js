...
function onload()
{
	...
	sRosCtx.startListeningTopic('imaginarium_core/Ultrasound','imaginarium_core/Ultrasound',function(data){console.log(data);});
	sRosCtx.startListeningTopic('imaginarium_core/CommandNosewheel','imaginarium_core/CommandNosewheel',function(data){console.log(data);});
